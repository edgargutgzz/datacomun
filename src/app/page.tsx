      ...
      <div className="min-h-[calc(100vh-1.5rem)] md:min-h-[calc(100vh-2.5rem)] grid md:grid-cols-[1.2fr_0.8fr]">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col justify-end flex-1 px-4 md:px-10 pt-10 pb-11 md:pt-0 md:pb-11">
            <div className="w-fit">
              <h1 className="text-[2.6rem] sm:text-[2.6rem] md:text-6xl font-semibold text-[#0f172a] leading-[1.05] tracking-tight">
                Herramientas de datos abiertos para organizaciones que transforman su <span className="logo-comun">comunidad</span>
              </h1>
            </div>
