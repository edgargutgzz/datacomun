    ...
    <div className="px-4 md:px-6 py-3 md:py-5">
      ...
      <div className="min-h-[calc(100vh-1.5rem)] md:min-h-[calc(100vh-2.5rem)] grid md:grid-cols-[1.2fr_0.8fr]">
        ...
        >
          ...
          {/* Copy */}
          <div className="relative z-10 flex flex-col justify-end flex-1 px-4 md:px-10 pt-10 pb-7 md:pt-0 md:pb-7">
            <div className="w-fit">
            ...
            <p className="mt-12 md:mt-20 text-base text-[#475569]">Hablemos de tu proyecto</p>
            <a
